...
trainFile = "/home/longht/Federated_object_detection/voc_2/1/ImageSets/Main/train.txt"
trainXMLFiles = list()
with open(trainFile, "rb") as f:
    for line in f:
        fileName = line.strip()
        # print(fileName.decode("utf-8"))
        trainXMLFiles.append(fileName.decode("utf-8") + ".xml")

if __name__ == '__main__':
    rootDir = "/home/longht/Federated_object_detection/voc_2/2/Annotations"
